...
public class YourFlightActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showBackBtn("Your Flights");

        mSectionsPagerAdapter = new MainPagerViewAdapter(getSupportFragmentManager(),0);
        mSectionsPagerAdapter.setContext(YourFlightActivity.this);
