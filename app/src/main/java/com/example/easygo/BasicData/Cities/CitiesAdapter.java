...
public class CitiesAdapter extends RecyclerView.Adapter<CitiesAdapter.ViewHolder> {
    ...
    private CitiesAdapter.AdapterListener onClickListener;


    public CitiesAdapter() {
    }

    public CitiesAdapter(Context context, List<CitiesModel> mList, AdapterListener onClickListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CitiesAdapter.ViewHolder holder, final int position) {
