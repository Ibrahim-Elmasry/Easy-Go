...
public class ProgramActivity extends BaseActivity {
    ...
    private void init(){
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Programs");
        ...
        LinearLayoutManager LayoutManager = new LinearLayoutManager(ProgramActivity.this);
        mRecyclerView.setLayoutManager(LayoutManager);

        // adapter
        mAdapter = new ProgramAdapter(ProgramActivity.this, mList, new ProgramAdapter.AdapterListener() {
            @Override
            public void detailsTrip(View v, CitiesModel model, String id) {
                Intent intent = new Intent(ProgramActivity.this, DetailsProgramCitiesActivity.class);
            ...
            public void editTrip(View v, CitiesModel model, String id) {
                Intent intent = new Intent(ProgramActivity.this, EditCompanyActivity.class);
                intent.putExtra("mModel",model);
                startActivity(intent);
            }
            ...
            public void deleteTrip(View v, String id) {
                mDb.collection("program").document(id)
                        .delete()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(ProgramActivity.this, "Delete Success", Toast.LENGTH_SHORT).show();
                                getData();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(ProgramActivity.this, "Delete Fail", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
    ...
    private void getData() {
        ...
        allTripsRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@javax.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @javax.annotation.Nullable FirebaseFirestoreException e) {
                if (e != null) {
                    Log.e("ProgramActivity", "onEvent: Listen failed.", e);
                    return;
                }
                Log.e("ProgramActivity", "onEvent:2 ");

                if (queryDocumentSnapshots != null) {
                    Log.e("ProgramActivity", "onEvent: ");
